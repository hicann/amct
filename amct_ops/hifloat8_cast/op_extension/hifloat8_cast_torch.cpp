...
// The ASC compiler emits this launcher with C++ linkage (mangled name); declaring it
// extern "C" would leave an undefined un-mangled symbol at load time.
void hifloat8_cast_kernel_lut(uint32_t blockDim, void *l2Ctrl, aclrtStream stream, uint8_t *input, uint8_t *output,
    uint8_t *tiling, uint8_t *lutGm);
