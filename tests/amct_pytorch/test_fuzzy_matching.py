...
class TestFuzzyPatternMatching(TestCast):
    ...
    def test_wildcard_prefix(self):
        ...
        self.assertTrue(
            match_fuzzy_pattern('model.layers.0.down_proj', PATTERN_STAR_DOWN_PROJ)
        )
        self.assertTrue(
            match_fuzzy_pattern('model.layers.1.down_proj', PATTERN_STAR_DOWN_PROJ)
        )
        self.assertFalse(
            match_fuzzy_pattern('model.layers.0.up_proj', PATTERN_STAR_DOWN_PROJ)
        )

    def test_wildcard_suffix(self):
        """Test suffix wildcard"""
        self.assertTrue(
            match_fuzzy_pattern('model.layers.0.down_proj', 'model.layers.*')
        )
        self.assertTrue(
            match_fuzzy_pattern('model.layers.1.down_proj', 'model.layers.*')
        )
    ...
    def test_wildcard_middle(self):
        ...
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.0.down_proj', PATTERN_MODEL_STAR_DOT_DOWN_PROJ
            )
        )
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.1.down_proj', PATTERN_MODEL_STAR_DOT_DOWN_PROJ
            )
        )
        self.assertFalse(
            match_fuzzy_pattern(
                'model.layers.0.up_proj', PATTERN_MODEL_STAR_DOT_DOWN_PROJ
            )
        )
    ...
    def test_wildcard_with_weights_suffix(self):
        ...
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.0.down_proj', PATTERN_STAR_DOWN_PROJ_WEIGHTS
            )
        )
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.0.down_proj.weights', PATTERN_STAR_DOWN_PROJ_WEIGHTS
            )
        )
        self.assertFalse(
            match_fuzzy_pattern(
                'model.layers.0.down_proj.inputs', PATTERN_STAR_DOWN_PROJ_WEIGHTS
            )
        )
    ...
    def test_wildcard_with_inputs_suffix(self):
        ...
        self.assertTrue(
            match_fuzzy_pattern('model.layers.0.q_proj', PATTERN_STAR_Q_PROJ_INPUTS)
        )
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.0.q_proj.inputs', PATTERN_STAR_Q_PROJ_INPUTS
            )
        )
        self.assertFalse(
            match_fuzzy_pattern(
                'model.layers.0.q_proj.weights', PATTERN_STAR_Q_PROJ_INPUTS
            )
        )
    ...
    def test_complex_pattern(self):
        ...
        self.assertTrue(
            match_fuzzy_pattern(
                'model.layers.0.self_attn.q_proj', '*self_attn.q_proj.inputs'
            )
        )
        self.assertFalse(
            match_fuzzy_pattern(
                'model.layers.0.self_attn.k_proj', '*self_attn.q_proj.inputs'
            )
        )
...
class TestInputsCfgFieldAdditional(TestCast):
    ...
    def test_get_fuzzy_config_inputs(self):
        ...
        try:
            ...
            assert (
                'Configuration must include at least one weights configuration'
                in str(e)
            )
...
class TestParserFunctionsAdditional(TestCast):
    ...
    def test_is_layer_supported_conv2d_padding_mode(self):
        ...
        is_supported = _is_layer_supported(
            mod, 'conv1', layer_types, quant_type_comb, quant_config
        )
