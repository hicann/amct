...
class TestTaylorLossSensitivity(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.config_helper = AutoChannelPruneConfigHelper(
            cls.graph, cls.config_defination, GraphQuerier, CAPACITY
        )
    ...
    def test_get_backward_grad(self):
        ...
        sentitvity_func.setup_initialization(
            graph_tuple=(self.graph, self.graph_info),
            input_data=self.sample_data,
            test_iteration=self.test_iteration,
        )
