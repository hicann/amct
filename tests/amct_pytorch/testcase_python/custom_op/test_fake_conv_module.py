...
class TestFakeConvModule(unittest.TestCase):
    ...
    def test_fake_conv_module(self):
        ...
        fake_conv = FakeQuantizedConv(sub_module, quant_params, "conv1")
    ...
    def test_fake_linear_module(self):
        ...
        fake_linear = FakeQuantizedLinear(sub_module, quant_params, "linear1")
    ...
    def test_fake_conv3d_module(self):
        ...
        fake_conv = FakeQuantizedConv(sub_module, quant_params, "conv2")
