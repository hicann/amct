...
from amct_pytorch.classic.graph_based.amct_pytorch.custom_op.dmq_balancer.dmq_balancer_func import (
    DMQBalancerFunction,
)
...
class TestDMQBalancerModule(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.conv_model2 = torch.nn.Conv2d(2, 4, kernel_size=2, groups=2)
...
class TestDMQBalancerFunc(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        pass
