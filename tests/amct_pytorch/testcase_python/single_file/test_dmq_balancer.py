...
from amct_pytorch.graph_based_compression.amct_pytorch.quantize_tool import quantize_preprocess
...
class TestDMQBalancer(unittest.TestCase):
    ...
    def test_dmq_balancer_config_not_support_value(self):
        ...
        with patch('amct_pytorch.graph_based_compression.amct_pytorch.configuration.check.GraphQuerier.get_support_dmq_balancer_types',
    ...
    def test_quantize_model_no_balance_factor_record(self):
        ...
        with patch('amct_pytorch.graph_based_compression.amct_pytorch.common.utils.parse_record_file.RecordManager.get_tensor_balance_factor',
                   return_value=None):
...
def do_calibration(model, args_shape, temp_folder):
    ...
    dmq_balancer_model = amct_pytorch.graph_based_compression.amct_pytorch.quantize_preprocess(
        config_file=TestDMQBalancer.config_file,
        model=model,
        input_data=input_data,
