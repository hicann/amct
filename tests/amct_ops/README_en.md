...
- Current environment has available `torch`, `TorchNPU`
...
```bash
# Validate only the native TorchNPU HiFloat8 cast
...
failure exits with `1`; a missing NPU, `TorchNPU`, `amct_ops`, or backend
