...
通义团队发布了Qwen3.6系列模型，本实践基于amct_pytorch中的量化工具，对Qwen3.6-MoE模型做了量化、数据提取与PTQ训练，使得模型在BF16和A8W4量化下ppl掉点在0.1以内。

---

## 硬件要求

产品型号：以Atlas A3 系列产品为例
...
### 本地编包
  ...
  本地编包流程请查看[环境安装&验证](../../../README.md#安装验证)
