...
本sample以Llama2-7b，qwen2-7b模型，pileval数据，wikitext2数据集为示例，请用户自行下载，并根据实际保存目录修改utils.py文件中get_llama2，get_loaders， get_calib_dataset等获取模型或数据函数中的读取路径。
...
|QWEN2-7B|pileval|wikitext2|7.137|7.208|
