# AMCT Large Model AWQ Quantization
...
`from amct_pytorch import MXFP4_AWQ_WEIGHT_QUANT_CFG`
...
The AWQ algorithm only supports weight quantization. The supported quantization types and quantization configurations are:
...
|algorithm|dict|Quantization algorithm configuration used|{'awq'}|/|
|algorithm.awq.grids_num|int|AWQ algorithm parameter: search grid count|/|/|
