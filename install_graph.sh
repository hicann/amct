...
SOURCE_URL="https://ascend-cann.obs.cn-north-4.myhuaweicloud.com/CANN/20260902_newest/${BASE_NAME}_9.2.0_linux-${ARCH}.tar.gz"
...
echo "tar -zxvf ${AMCT_GRAPH_FILE} -C $BUNDLE_DIR"
tar -zxvf "${AMCT_GRAPH_FILE}" -C "$BUNDLE_DIR"
