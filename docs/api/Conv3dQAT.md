...
<td class="cellrowborder" valign="top" width="80.47%" headers="mcps1.2.4.1.3 "><p id="p15629529185012"><a name="p15629529185012"></a><a name="p15629529185012"></a>含义：量化配置。配置参考样例如下，量化配置参数的具体说明请参见<a href="../context/singleop_config.md">量化配置参数说明</a>。</p>
