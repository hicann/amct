...
<td class="cellrowborder" valign="top" width="77.74%" headers="mcps1.1.4.1.3 "><p id="p3490152934016"><a name="p3490152934016"></a><a name="p3490152934016"></a>含义：待分解的含有预训练权重的PyTorch模型对象。在调用该接口时建议将模型放置于CPU上，以防分解时显存不足。</p>
