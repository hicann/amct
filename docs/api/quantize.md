...
<a name="ul7111191082014"></a><a name="ul7111191082014"></a><ul id="ul7111191082014"><li>tensor，对应per-tensor。</li><li>token，对应per-token。</li><li>group，对应per-group，该参数只支持量化数据类型为mxfp8_e4m3fn时配置。</li></ul>
</td>
</tr>
