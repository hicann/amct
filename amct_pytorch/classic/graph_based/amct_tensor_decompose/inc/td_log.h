...
#define TD_NULLPTR_CHECK_DOUBLE(ptr1, ptr2)       \
    do {                                          \
...
#define TD_NULLPTR_CHECK_TRIPLE(ptr1, ptr2, ptr3)                    \
    do {                                                             \
...
#define TD_CHECK_NORMAL_ZERO_LENGTH(length) \
    do {                                    \
        if (length == 0) {                  \
