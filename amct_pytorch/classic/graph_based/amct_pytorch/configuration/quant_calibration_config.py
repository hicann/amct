...
from ...amct_pytorch.configuration.quant_calibration_config_base.quant_calibration_config_base import (
...
def inner_create_quant_calibration_config(
    ...
    if not os.path.isfile(config_defination):
        raise RuntimeError(
            'Invalid argument config_defination. '
...
def get_quant_layer_config(layer_name, quant_calibration_config):
    ...
    return QuantCalibrationConfigBase.get_quant_layer_config(
        layer_name, quant_calibration_config
    )
