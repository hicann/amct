...
class CompModuleConvTranspose3d(CompModuleBase):
    """
    Function: Quantization module class after Quantization module after ConvTranspose3d encapsulation.
    APIs: __init__, forward
    """

    def __init__(self, *args, **kwargs):
        super(CompModuleConvTranspose3d, self).__init__(*args, **kwargs)
    ...
    def forward(self, inputs, output_size=None):
        ...
        compressed_inputs, compressed_weights = super(
            CompModuleConvTranspose3d, self
        ).forward(inputs)
