...
class AdaRoundQuant(torch.nn.Module):
    ...
    def __init__(self, module, wts_param, data_tensor, tensor_balance_factor):
        ...
        self.scale, self.offset = find_scale_and_offset_by_kl(
            data_tensor, self.wts_param['channel_wise']
        )
    ...
    def get_scale_offset(self):
        ...
        if (
            isinstance(self.module, nn.ConvTranspose2d)
            and self.module.groups > 1
            and self.wts_param['channel_wise']
        ):
    ...
    def _init_alpha(self):
        ...
        if isinstance(self.module, nn.ConvTranspose2d):
            ...
            if self.module.groups > 1 and self.wts_param['channel_wise']:
                ...
                self.scale = self.scale.reshape(
                    self.module.groups, out_channel_div_groups, 1, 1
