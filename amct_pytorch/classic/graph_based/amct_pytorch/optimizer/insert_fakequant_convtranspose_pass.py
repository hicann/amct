...
from ...amct_pytorch.custom_op.fake_quant import FakeQuantizedConvTranspose


class InsertFakequantConvTransposePass(BaseModuleFusionPass):
    """
    ...
    def do_pass(self, model, object_module, object_name, graph=None):
        """
        Function: insert fake quant ConvTranpose2d.
        Parameters:
