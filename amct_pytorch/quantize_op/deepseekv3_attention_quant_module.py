...
from amct_pytorch.quantize_op.utils import calculate_quantile_ema_scale
...
class DeepseekV3AttentionQuant(BaseQuantizeModule):
    ...
    def __init__(self,
        ...
        if not self.kvcache_enable:
            LOGGER.logd("kvcache is not enable of layer '{}'!".format(self.layer_name), 'DeepseekV3AttentionQuant')
