...
def parser_gen():
    ...
    # General Arguments
    parser.add_argument(
        '--model', type=str, default='deepseek-ai/DeepSeek-V3.2', help='Model to load.'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--cali_bsz', type=int, default=4, help='Batch size default is 4.'
    )
    parser.add_argument(
        '--base_lr',
        type=float,
    ...
    args.exp_dir = os.path.join(
        args.output_dir, f"w{args.w_bits}a{args.a_bits}_{args.train_mode}"
    )
