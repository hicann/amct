...
class Hifloat8FakequantLinear(BaseQuantizeModule):
    ...
    def __init__(self, ori_module, layer_name, quant_config):
        ...
        hif8_weight = hifloat8_cast.float_to_hifloat8(
            (ori_module.weight / scale_w).cpu()
        )
        self.fakequant_weight = (
            hifloat8_cast.hifloat8_to_float32(hif8_weight).to(ori_module.weight)
            * scale_w
        )
