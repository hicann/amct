...
def tensor_int32_to_int4s_torch(
    tensor_int32: torch.Tensor, output_dtype
) -> torch.Tensor:
...
class AscendW4A4FlatQuantDynamicLinearMethod:
    ...
    def apply(
        ...
        x_quantized_int4, activation_scale = batched_kronecker_quant(
            x_reshaped, left_trans_matched, right_trans_matched, aclnn_clip_ratio
        )
...
def dynamic_w4a4(x, w_packed, w_scale, bias=None):
    ...
    x_quantized, pertoken_scale = torch_npu.npu_dynamic_quant(
